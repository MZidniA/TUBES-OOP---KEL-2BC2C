...
public class KeyHandler implements KeyListener {
   ...
   // Di dalam kelas org.example.controller.KeyHandler
@Override
public void keyPressed(KeyEvent e) {
    int code = e.getKeyCode();
    GameState currentGameState = gameController.getGameState(); // Dapatkan state saat ini
...
// Metode keyReleased tetap sama, hanya untuk menghentikan pergerakan play state
